  ...
  <Box color="black">
    ...
    <div id="container">
      <TextBox>
        ...
        <h3>매주 5백 여편의 신작이 업데이트 되며, 추가 요금은 전혀 없어요.</h3>
      </TextBox>
      <ButtonBox>
    ...
    <div id="container" >
      <TextBox>
        ...
        <h3>동시 4개 기기에서 재생이 가능한 프리미엄 이용권을 이용해보세요.</h3>
      </TextBox>
      <ButtonBox>
        <StartButton>2주 무료 이용 시작</StartButton>
        <DownButton>↓</DownButton>
    ...
    <div id="container" backgroundImage = "url(back1.jpg)">
      <TextBox>
        ...
        <h3>최대 Ultra HD 4K 해상도로 생생한 감동을 느껴보세요.</h3>
      </TextBox>
      <ButtonBox>
        <StartButton>2주 무료 이용 시작</StartButton>
        <DownButton>↓</DownButton>
    ...
    <div id="container">
      <TextBox>
        ...
        <h3>보고 싶은 콘텐츠를 다운로드하여 오프라인으로 즐기세요.</h3>
      </TextBox>
      <ButtonBox>
        <StartButton>2주 무료 이용 시작</StartButton>
        <DownButton>↓</DownButton>
